...
def objective_lpsp_v3(dispatch_results: Dict) -> float:
    ...
    raise NotImplementedError("LPSP V3 - implement with test in next phase")

def objective_co2_v3(dispatch_results: Dict, lifetime_years: int = PROJECT_LIFETIME_YEARS) -> float:

    raise NotImplementedError("CO2 V3 - implement with test in next phase")

def objective_gini_spatial_v3(renewable_fraction_per_household: np.ndarray) -> float:

    raise NotImplementedError("Gini V3 - implement with test in next phase")

if __name__ == "__main__":
    import doctest
    print("Running doctests for objective_functions_v3.py...")
